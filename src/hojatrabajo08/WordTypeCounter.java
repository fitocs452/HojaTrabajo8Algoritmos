...
public class WordTypeCounter {
	public WordTypeCounter(String[] args) throws Exception
	{       
            if(args.length > 1)
		{
			...
			if(wordFile.isFile() && textFile.isFile()) {
				...
				// de comando
				// =====================================================
				WordSet words =  WordSetFactory.crearArbol(implementacion);
				// =====================================================
